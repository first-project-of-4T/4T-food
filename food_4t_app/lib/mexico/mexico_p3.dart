      ...
      body: Center(
        child: Column(
          ...
          children: [
            ...
            Text('부리또는 멕시코의 대표적인 간편 음식으로, 밀가루 토르티야에 다양한 재료를 싸서 만든 음식입니다. 보통 안에는 고기(소고기, 돼지고기, 닭고기 등), 콩, 쌀, 치즈, 상추, 살사 등이 들어가며, 취향에 따라 다양한 재료를 추가할 수 있습니다. 부리또는 포장하여 쉽게 먹을 수 있어 멕시코뿐만 아니라 전 세계에서 인기가 많습니다.',
